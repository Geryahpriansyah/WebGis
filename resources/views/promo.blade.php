...
<div class="container">
    ...
    <div class="row">
      <div class="col-4">
        <div class="card" >
          <img src="img/wepik-export-202312141701318XEO.png" class="card-img-top" alt="...">
        </div>
        <p>Burger Beef Sapi</p>
        <p>Rp.30.000,-</p>
        <button type="button" class="btn btn-order">Order Now</button>
      </div>
      <div class="col-4">
        <div class="card" >
          <img src="img/wepik-export-2023121416580819A8.png" class="card-img-top" alt="...">
         
        </div>
        <p>Burger Beef Ayam</p>
        <p>Rp.30.000,-</p>
        <button type="button" class="btn btn-order">Order Now</button>
      </div>
      <div class="col-4">
        <div class="card" >
          <img src="img/card1-removebg-preview.png" class="card-img-top" alt="...">
...
<div class="container">
    <div class="promosi1">
        <h1>Promo %</h1>
        <div class="card mb-3">
            <img src="img/Promo1.png" class="card-img-top" alt="...">
            <div class="card-body">
          ...
          <div class="card ">
            <img src="img/Promo3.png" class="card-img-top" alt="...">
            <div class="card-body">
              <h5 class="card-title">Card title</h5>
              <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
              <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
